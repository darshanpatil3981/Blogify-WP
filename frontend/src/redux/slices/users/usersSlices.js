  ...
  async (user, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.post(
        `https://backendtry2022.herokuapp.com/api/users/register`,
        user,
        config
      );
      return data;
...
export const loginUserAction = createAsyncThunk(
  ...
  async (userData, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      //make http call
      const { data } = await axios.post(
        `https://backendtry2022.herokuapp.com/api/users/login`,
        userData,
        config
      );
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.get(
        `https://backendtry2022.herokuapp.com/api/users/profile/${id}`,
        config
      );
      return data;
    } catch (error) {
  ...
  async (userData, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.put(
        `https://backendtry2022.herokuapp.com/api/users`,
        {
...
export const logoutAction = createAsyncThunk(
  "https://backendtry2022.herokuapp.com/user/logout",
...
export const uploadProfilePhototAction = createAsyncThunk(
  ...
  async (userImg, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://backendtry2022.herokuapp.com/api/users/profilephoto-upload`,
        formData,
        config
      );
      return data;
