  ...
  async (category, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.post(
        `https://backendtry2022.herokuapp.com/api/category`,
        {
...
export const fetchCategoriesAction = createAsyncThunk(
  ...
  async (category, { rejectWithValue, getState, dispatch }) => {
    ...
    //http call
    try {
      const { data } = await axios.get(`https://backendtry2022.herokuapp.com/api/category`, config);
      return data;
    } catch (error) {
      if (!error?.response) {
        throw error;
  ...
  async (category, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.put(
        `https://backendtry2022.herokuapp.com/api/category/${category?.id}`,
        { title: category?.title },
        config
      );
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.delete(
        `https://backendtry2022.herokuapp.com/api/category/${id}`,
        config
      );
      //dispatch action
...
export const fetchCategoryAction = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    ...
    //http call
    try {
      const { data } = await axios.get(`https://backendtry2022.herokuapp.com/api/category/${id}`, config);
      return data;
    } catch (error) {
      if (!error?.response) {
        throw error;
